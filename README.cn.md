...
[![x-cmd/install — minikube Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/minikube.svg?lang=zh)](https://x-cmd.com/install/minikube)
...
合计: **303,535** 行代码（覆盖前 5 种语言、共 **1359** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Yaml | 154,911 | 2,400 | 345 | 224 |
| Go | 109,225 | 21,186 | 17,673 | 833 |
| Json | 18,319 | 0 | 0 | 33 |
| Html | 12,314 | 19 | 2,898 | 162 |
| Sh | 3,426 | 2,177 | 1,147 | 107 |
...
- **上游仓库**: <https://github.com/kubernetes/minikube>
- **官网**: <https://minikube.sigs.k8s.io/>
- **许可证**: Apache-2.0

## 发布

- **最新版本**: `v1.39.0` (2026-09-02)
- **最近提交**: 2026-09-24
- **Release 含资产**: 50 个

## 流行度

- **Star**: 32,154 · **Fork**: 5,331 · **开放 issue**: 10,667 · **贡献者**: 1,516

## 累计统计

- **发布数**: 155 · **已合并 PR**: 9794 · **开放 PR**: 133 · **已关闭 issue**: 10195 · **开放 issue**: 472 · **提交数**: 28351

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-26 | 1 | 88 | 44 | 24 | 38 | 227 |
| last60d | 2026-07-27 | 1 | 147 | 64 | 36 | 49 | 402 |
| 90d | 2026-06-27 | 1 | 212 | 77 | 48 | 58 | 569 |
| last180d | 2026-03-29 | 1 | 385 | 105 | 89 | 112 | 919 |
| 360d | 2025-09-30 | 3 | 891 | 128 | 304 | 159 | 1724 |
| last720d | 2024-10-05 | 6 | 1664 | 131 | 809 | 203 | 3165 |
...
minikube 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `minikube` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/minikube.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260925.yml` · 2026-09-25T04:48:45Z._
